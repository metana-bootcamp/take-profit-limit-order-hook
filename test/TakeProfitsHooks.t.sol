...
import {TakeProfitsHooks} from "src/TakeProfitsHooks.sol";
...
contract TakeProfitHookTest is Test, Deployers {
    ...
    function setUp() public {
        ...
        deployCodeTo("TakeProfitsHooks", abi.encode(manager, ""), hookAddress);

        // initialize hook
        hook = TakeProfitsHooks(hookAddress);

        // Approve hook address to spend tokens
